...
if ( ! class_exists( '\fazzo\fazzo' ) ) {
	...
	class fazzo {
		...
		protected static function get_options() {
			...
			fazzo_functions::parse_args_multidim( $options, $defaults );
		...
		public function settings_page_display() {
			...
			// Speichern
			if ( fazzo_functions::validate_nonce( $nonce_input_key, $nonce_name ) ) {
...
$val = "";
		...
		public function customizer_css() {
			...
			if ( ! empty( $background_image2_id ) ) {
				...
				$background_color_rgb = fazzo_functions::get_rgb_from_hex( $background_color );
			...
			$main_menu_color_rgb        = fazzo_functions::get_rgb_from_hex( $main_menu_color );
			$main_menu_color2           = get_theme_mod( 'fazzo_main_menu_color2', static::$customizer_defaults["fazzo_main_menu_color2"] );
			$main_menu_color2_rgb       = fazzo_functions::get_rgb_from_hex( $main_menu_color2 );
			...
			$main_menu_border_color_rgb = fazzo_functions::get_rgb_from_hex( $main_menu_border_color );
			...
			if ( $main_menu_border_color_rgb ) {
				$css_ar["#head-bottom-wrapper"][]
					                             = "border-top: 1px solid rgba(" . $main_menu_border_color_rgb["r"] . ", " . $main_menu_border_color_rgb["g"] . ", " . $main_menu_border_color_rgb["b"] . ", 1);";
